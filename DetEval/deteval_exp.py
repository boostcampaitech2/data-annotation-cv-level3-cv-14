...
def calc_deteval_metrics(pred_bboxes_dict, gt_bboxes_dict, transcriptions_dict=None,
    ...
    methodMetrics = {'precision': methodPrecision, 'recall': methodRecall,'hmean': methodHmean} #hmean은 조화평균, f1 score
...
if __name__ == '__main__':
    ...
    for sample_name, rest in valid_data['images'].items():
        ...
        if points_info.empty: 
            ...
            transcriptions_dict[sample_name] = list(points_info['transcription'])
